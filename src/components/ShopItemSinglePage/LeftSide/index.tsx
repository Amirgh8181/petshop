...
const ShopItemLeftSide = ({ product }: { product: ShopItem }) => {
    const tabData: tabsDetailstype[] = [
        { key: "Product details", title: "Product details", description: product?.description },
        { key: "Specifications", title: "Specifications", description: product?.description },
        { key: "reviews", title: "reviews", description: product?.description },
    ]
    return (
        <>
            <div>
