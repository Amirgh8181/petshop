  ...
  return (
    <div className='w-[90vw] min-h-screen relative flex mt-6'>
      <div className='md:w-3/4 w-[65%] min-h-screen flex flex-col items-center gap-4'>
        {
          CartItem?.map(item =>
            <div className='w-[90%] md:h-[40vh] h-[20vh] flex items-center justify-around rounded-2xl shadow-xl' key={item.id}>
              <div className='w-[60%] h-[90%] flex items-center'>
                <Image src={item.image} alt='cart item image' width={300} height={300}
                  className='md:w-[40%] w-[70%] aspect-square' />
                <div className='md:text-2xl'>{item.title}</div>
              </div>
              ...
              <div className='w-[40%] flex md:flex-row flex-col items-center justify-evenly'>
                ...
                <div className='order-1 md:order-2 flex flex-col md:flex-row items-center md:space-x-2'>
                  ...
                  <span onClick={() => setDeleteItem(item)}
